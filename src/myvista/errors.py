...
_BY_TYPE: dict[str, type[MyVistaError]] = {
    ...
    "route_exhausted": APIStatusError,
    "provider_timeout": APIStatusError,
    "runtime_timeout": APIStatusError,
    "provider_unavailable": APIStatusError,
    "litellm_unavailable": APIStatusError,
    "ollama_unavailable": APIStatusError,
    "vllm_unavailable": APIStatusError,
